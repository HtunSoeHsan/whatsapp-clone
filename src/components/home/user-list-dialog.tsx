...
const UserListDialog = () => {
  ...
  const handleCreateConversation = async () => {
    ...
    try {
        ...
        if(!isGroup) {
            conversationId = await createConversation({participants: [...selectedUsers, me?._id!], isGroup: false});
        ...
        //TODO: update a global state call selectedComversationId
        ...
        toast.error("Fail to create conversation!");
